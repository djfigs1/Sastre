...
if __name__ == "__main__":
    ...
    parser.add_argument("-r", "--recipe-file", action="store", dest="recipe_path", default=None, help="create resume from recipe file")
    ...
    recipe = ResumeRecipe(path=args.recipe_path)
